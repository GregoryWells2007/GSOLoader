...
public:
    ...
    gso_string_type operator +(char val) { return add_string(value, val); }
    gso_string_type operator +(char* val) { return add_string(value, val); }
    gso_string_type operator +(const char* val) { return add_string(value, unconst_char_ptr(val));}

    void operator =(gso_string_type val) { value = val; }
    ...
    bool operator ==(gso_string_type val) { return (strcmp(value, unconst_char_ptr(val)) == 0); }
    ...
    gso_string_type substring(int index1, int index2) {
        gso_string_type out_value;
